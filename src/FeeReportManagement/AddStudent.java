    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==bt1)
        {
            try
            {
                ...
                String q = "insert into add_student(name,email,course,fees,paid,due,address,city,state,country,contact)"
                        + " values('"+name+"','"+email+"','"+course+"','"+fees+"','"+paid+"','"+due+"','"+address+"','"+city+"','"+state+"','"+country+"','"+contact+"')";
