        ...
        ch.addMouseListener(new MouseAdapter()
        {
            ...
            public void mouseClicked(MouseEvent arg0)
            {
                try
                {
                    ...
                    String q1 = "select * from add_student where rollNo='"+rollno+"'";
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==bt1)
        {
            try
            {
                ...
                String q = "update add_student set name='"+name+"',email='"+email+"',course='"+course+"',fees='"+fees+"',paid='"+paid+"',due='"+due+"',address='"+address+"',city='"+city+"',state='"+state+"',country='"+country+"',contact='"+contact+"' where rollno='"+roll+"'";
